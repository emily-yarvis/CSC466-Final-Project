...
public class MovieMatrixRish {
    private final List<MovieRish> movies;
    ...
    public MovieMatrixRish(List<MovieRish> movies) {
        this.movies = movies;
    ...
    private List<String> findAllGenres() {
        ...
        for (MovieRish movie : movies) {
            for (GenreRish g : movie.getGenres()) {
    ...
    private List<String> findAllLanguages() {
        ...
        for (MovieRish movie : movies) {
            for (LanguageRish l : movie.getSpokenLanguages()) {
    ...
    private List<String> findAllCollections() {
        ...
        for (MovieRish movie : movies) {
            CollectionInfoRish c = movie.getBelongsToCollection();
            if (c != null) {
    ...
    private List<String> findAllProductionCompanies() {
        ...
        for (MovieRish movie : movies) {
            for (ProductionCompanyRish p : movie.getProductionCompanies()) {
    ...
    private List<String> findAllCountries() {
        ...
        for (MovieRish movie : movies) {
            for (CountryRish c : movie.getProductionCountries()) {
    ...
    private void populateFeaturesMatrix() {
        ...
        for (int i = 0; i < n; i++) {
            ...
            for (String collName : COLLECTION_INFOS) {
                CollectionInfoRish col = movie.getBelongsToCollection();
